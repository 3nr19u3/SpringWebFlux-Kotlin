...
class SpringBootWebfluxApirestApplication: CommandLineRunner{
	...
	private val logger = LoggerFactory.getLogger(SpringBootWebfluxApirestApplication::class.java)
...
fun main(args: Array<String>) {
	runApplication<SpringBootWebfluxApirestApplication>(*args)
}
